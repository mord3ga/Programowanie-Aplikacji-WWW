    ...
    <div class="admin-container">
        ...
        <form method="post" action="' . $formAction . '" class="edit-form">
            <div class="form-group">
                ...
                <input type="text" id="page_title" name="page_title" value="' . htmlspecialchars($title) . '" required class="form-input" placeholder="np. Strona główna, O nas">
            </div>
            
            <div class="form-group">
                <label for="page_alias">Alias:</label>
                <input type="text" id="page_alias" name="page_alias" value="' . htmlspecialchars($alias) . '" class="form-input" placeholder="np. home, about, kontakt (opcjonalne)">
                <small style="display: block; margin-top: 5px; color: #666;">Alias będzie używany w adresie URL (index.php?page=ALIAS). Zostaw puste - wtedy użyje ID.</small>
            </div>
            
            <div class="form-group">
                <label for="page_content">Treść strony:</label>
                <textarea id="page_content" name="page_content" rows="15" required class="form-textarea" placeholder="Wpisz treść strony (może zawierać HTML)">' . htmlspecialchars($content) . '</textarea>
            </div>
            ...
            <div class="form-group checkbox-group">
                ...
                <small>Odznacz, jeśli strona ma być nieaktywna (ukryta)</small>
            </div>
